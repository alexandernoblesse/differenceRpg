# Project Gemini TTRPG System - Version 0.6
...
| **4** | Flustered | You've lost your train of thought. You cannot use the `Gain Advantage` action for social checks for the scene. | Automatically fades at the end of the scene. | A "Moment of Grace" cantrip. |
